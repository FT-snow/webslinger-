...
class AsciiFilter {
  ...
  constructor(renderer: THREE.WebGLRenderer, options: {
    ...
    // Use standard imageSmoothingEnabled instead of vendor-specific properties
...
class CanvAscii {
  ...
  private onMouseMoveHandler: (evt: MouseEvent | TouchEvent) => void;
  ...
  constructor(
    ...
    this.onMouseMoveHandler = (evt: MouseEvent | TouchEvent) => {
  ...
  dispose() {
    ...
    this.filter.dispose();
    if (this.container && this.filter.domElement.parentNode) {
